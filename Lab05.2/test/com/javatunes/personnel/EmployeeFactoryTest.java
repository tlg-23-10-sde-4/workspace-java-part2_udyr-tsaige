...
public class EmployeeFactoryTest {
    ...
    public void createEmployee_shouldReturnSalariedEmployee_whenTypeSE() {
        ...
        assertEquals(SalariedEmployee.class, emp.getClass()); // exact match

        verifyNameAndHireDate(emp, "Jackie");


        // downcast reference 'emp' to more specific type salaried type, to call those methods
    ...
    private void verifyNameAndHireDate(Employee emp, String jackie) {
    ...
    public void createEmployee_shouldReturnHourlyEmployee_whenTypeHE() {
        ...
        // be sure that emp really is HourlyEmployee
        assertEquals(HourlyEmployee.class, emp.getClass());

        verifyNameAndHireDate(emp, "Jackie");

        // downcast reference 'emp' to more specific type Hourly type, to call those methods
